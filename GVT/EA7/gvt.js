var app = ( function() {
	...
	function initModels() {
		...
		createModel("sphere", fs, [1, 1, 1, 1], [-1, .5, 0], [0, 0, 0], [.5, .5, .5]);
		createModel("torus", fs, [1, 1, 1, 1], [-1, .5, 0], [1, 0, 1], [1, 1, 0.5]);

		//UFO
		createModel("sphere", fs, [1, 1, 1, 1], [1, 1.2, 0], [0, 0, 0], [.3, .2, .3]);
		createModel("torus", fs, [1, 1, 1], [1, 1.2, 0], [1.5, 0, 1], [.4, .4, .3]);
		createModel("zylinder", fs, [1, 1, 1, 1], [0.8, 1.6, 0], [0, 0, 0], [.1, .2, .1]);
