var app = (function() {
    ...
    var illumination = {
        ...
        light : [ 
			...
			{isOn:true, position:[-3.,1.,-3.], color:[1,.5,1.]}, 
		]
    };
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            // Scale/squeese interactiveModel and Rotate Lights.
            switch (c) {
            case ('S'):
			...
			case ('L'): {
                angle += deltaRotate;
				illumination.light[0].position[0] = Math.sin(angle - Math.PI/2)*-3;
                illumination.light[0].position[2] = Math.cos(angle - Math.PI/2)*-3;
                illumination.light[1].position[0] = -Math.sin(angle + Math.PI/2)*3;
                illumination.light[1].position[2] = -Math.cos(angle + Math.PI/2)*3;
				break;
			}
            case ('I'): {
                angle -= deltaRotate;
