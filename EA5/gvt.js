var app = ( function() {
 ...
 function createModel(geometryname, fillstyle) {
    ...
    /**
     * Calculates the position of the camera orbiting the center
     */
	...
	function render() {
        ...
        // glMatrix.mat4.rotate(camera.vMatrix, camera.vMatrix, Math.PI/4, [1,0,0]);
        calculateCameraOrbit();

        //Set the view Matrix depending on the camera
